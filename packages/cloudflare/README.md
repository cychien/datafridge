...
See the [Cloudflare guide](https://github.com/cychien/datafridge/blob/main/docs/cloudflare.md) and [API reference](https://github.com/cychien/datafridge/blob/main/docs/api.md).
